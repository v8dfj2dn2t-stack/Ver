...
они закрашены как обычные субъекты Южного федерального округа; флаг `disputed` нужен
только для примечания в карточке. Для четырёх областей 2022 года площадь и население —
довоенные данные по украинской области, а не перепись 2021 года.
