...
они закрашены как обычные субъекты Южного федерального округа. Флаг `disputed` и поле
`note` остаются в данных, но на странице сейчас не выводятся. Для четырёх областей
2022 года площадь и население — довоенные данные по украинской области (оценка на
2022 год), а не перепись 2021 года: на карте это никак не помечено, имейте в виду
при использовании цифр.
